...
export default class Slider extends PureComponent {
  static propTypes = {
    ...
    midTrackColor: PropTypes.string,
    /**
  ...
  render() {
    ...
    const midTrackWidth = ((midValue/maximumValue)*100)
    ...
    const minimumTrackStyle = {
      zIndex: 3,
      position: 'absolute',
      width: Animated.add(minimumTrackWidth, thumbSize.width),
    ...
    return (
      ...
      >
        ...
        <Animated.View
          renderToHardwareTextureAndroid
          style={[mainStyles.track, trackStyle, midTrackStyle]}
        />
        <Animated.View
